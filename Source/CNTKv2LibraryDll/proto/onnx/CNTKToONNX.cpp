...
private:
    ...
    static onnxruntime::Node* AddConstantLikeNode(onnxruntime::NodeArg& inputArg, const std::string& outArgName, onnxruntime::Graph* graph,
                                                  const float value);
    static onnxruntime::Node* AddPadNode(onnxruntime::NodeArg& inputArg, const std::string& outArgName, onnxruntime::Graph* graph,
...
// add Pad node
onnxruntime::Node* CNTKToONNXHelper::AddPadNode(onnxruntime::NodeArg& inputArg, const std::string& outArgName, onnxruntime::Graph* graph,
    ...
    bool isFirst)
{
    ...
    Node* padNode = AddPadNode(const_cast<NodeArg&>(const_cast<NodeArg&>(*constantLikeNode->OutputDefs().at(0))),
                               ToLegacyString(ToUTF8(src->Uid())) + "_padding_output", graph, pads, 1.0F);
